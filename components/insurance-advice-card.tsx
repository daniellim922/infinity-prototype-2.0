        ...
        <Card>
            ...
            <CardContent>
                <Sheet>
                    ...
                    <SheetContent className="overflow-y-auto data-[side=right]:sm:max-w-6xl">
                        <SheetHeader>
                        ...
                        <FieldGroup className="gap-4 p-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Field>
                                    ...
                                    <Input id="policy-term" type="number" />
                                </Field>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Field>
                                    ...
                                    <Input id="premium-term" type="number" />
                                </Field>
                                <Field>
                                    <FieldLabel htmlFor="min-investment">
                                        Minimum Investment Period (For ILP)
                                    </FieldLabel>
                                    <Input id="min-investment" type="number" />
                                </Field>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <Field>
                                    ...
                                    <Input id="premium-amount" type="number" />
                                </Field>
                            </div>
